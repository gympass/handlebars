...
var dataTests = []Test{
	{
		...
		map[string]interface{}{"hello": func(options *raymond.Options) (string, error) {
			return options.DataStr("adjective") + " " + options.ValueStr("noun"), nil
		}},
		nil,
		"happy cat",
	},
	...
	},
	{
		...
		map[string]interface{}{"hello": "hello"},
		map[string]interface{}{"let": func(options *raymond.Options) (string, error) {
			...
			return options.FnData(frame), nil
		}},
		nil,
		"Hello world",
	},
	{
		...
		map[string]interface{}{"hello": func(context string) (string, error) {
	...
	},
	{
		...
		map[string]interface{}{"world": "world"},
		map[string]interface{}{"hello": func(options *raymond.Options) (string, error) {
			return "Hello " + options.HashStr("noun"), nil
		}},
		nil,
		"Hello world",
	},
...

	{
		...
		`{{@hello}}`,
		nil,
		map[string]interface{}{"hello": func() (string, error) { return "hello", nil }},
		nil, nil,
		"hello",
	},
	{
		...
		`{{@hello "hello"}}`,
		nil,
		map[string]interface{}{"hello": func(context string) (string, error) { return context, nil }},
		nil, nil,
		"hello",
	},
	...
	},
	{
		...
		map[string]interface{}{"adjective": "happy"},
		map[string]interface{}{"hello": func(context string, options *raymond.Options) (string, error) {
			str := "error"
			...
			return options.DataStr("adjective") + " " + context + str, nil
		}},
		nil,
		"happy world!",
	},
	{
		...
		map[string]interface{}{
			"hello": func(options *raymond.Options) (string, error) {
				return options.Fn(), nil
			},
			"world": func(options *raymond.Options) (string, error) {
				str := "error"
				if b, ok := options.Value("exclaim").(bool); ok {
					if b {
						str = "!"
				...
				return options.DataStr("adjective") + " world" + str, nil
			},
		},
		nil,
		"happy world!",
	},
	{
		...
		map[string]interface{}{
			"hello": func(options *raymond.Options) (string, error) {
				return options.FnWith(map[string]string{"exclaim": "?"}), nil
			},
			"world": func(context string, options *raymond.Options) (string, error) {
				return options.DataStr("adjective") + " " + context + options.ValueStr("exclaim"), nil
			},
		},
		nil,
		"happy world?",
	},
	{
		...
		map[string]interface{}{
			"hello": func(options *raymond.Options) (string, error) {
				return options.DataStr("accessData") + " " + options.FnWith(map[string]string{"exclaim": "?"}), nil
			},
			"world": func(context string, options *raymond.Options) (string, error) {
				return options.DataStr("adjective") + " " + context + options.ValueStr("exclaim"), nil
			},
	...
	},
	{
		...
		map[string]interface{}{
			"hello": func(options *raymond.Options) (string, error) {
				...
				return options.FnCtxData(ctx, data), nil
			},
			"world": func(context string, options *raymond.Options) (string, error) {
				return options.DataStr("adjective") + " " + context + options.ValueStr("exclaim"), nil
			},
	...
	},
	{
		...
		map[string]interface{}{
			"helper": func(options *raymond.Options) (string, error) {
				data := options.NewDataFrame()
				...
				return options.FnData(data), nil
			},
		},
		nil,
		"2 1 0",
